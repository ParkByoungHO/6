...
class Fkey:
    ...
    image = None
    def __init__(self):
        self.x , self.y = 45,random.randint(800,50500)
...
class Tkey:
    ...
    image = None
    def __init__(self):
        self.x , self.y = 90,random.randint(800,50500)
        self.total_frames = 0.0
        self.dir = -1
        self.frame = 0
        if Tkey.image == None:
...
class Hkey:
    ...
    image = None
    def __init__(self):
        self.x , self.y = 140,random.randint(800,50500)
        self.total_frames = 0.0
        self.dir = -1
        self.frame = 0
        if Hkey.image == None:
...
class Ukey:
    ...
    image = None
    def __init__(self):
        self.x , self.y = 188,random.randint(800,50500)
        self.total_frames = 0.0
        self.dir = -1
        self.frame = 0
        if Ukey.image == None:
...
class Kkey:
    ...
    image = None
    def __init__(self):
        self.x , self.y = 230,random.randint(800,50500)
        self.total_frames = 0.0
        self.dir = -1
        self.frame = 0
        if Kkey.image == None:
...
def enter():
    ...
    global cool,good,fail,sum,Score
    ...
    Fkeynote=[Fkey() for i in range (60)]
    Tkeynote=[Tkey() for o in range (60)]
    Hkeynote=[Hkey() for p in range (65)]
    Ukeynote=[Ukey() for u in range (65)]
    Kkeynote=[Kkey() for y in range (65)]
    cool = Cool()
    good = Good()
    fail = Fail()
    Score = score()
...
def exit():
    ...
    global green,blue
    global F,T,H,U,K
    global cool,good,fail,coolcount,goodcount,failcount,sum,combocount,Score
    del(bgimage)
    del(button)
    del (motionF)
    del (motionT)
...
def handle_events(frame_time):
    events = get_events()
    global green,blue,running,F,T,H,U,K,example,sound
    for event in events:
...
def draw(frame_time):
    ...
    global green,blue,F,T,H,U,K
    global cool,good,fail,count,coolcount,goodcount,failcount,sum
    global Score
